...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : CK HACKER  

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : Fb Trick

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : CKHACKERs
...
"\r\r %s[CK] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
...
print("\r  \033[0;91m   [CK-CP] %s | %s\033[0;97m         "%(uid, pw))
